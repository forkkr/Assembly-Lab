...
loop1:	mov 	qword [dd1+rdi], rdi	; dd1[i]=7;
	...
	mov	rcx, qword [dd1+97*8]	; dd1[98]  third list parameter
	mov	r8,  qword [dd1+98*8]	; dd1[99]  fourth list parameter
